...
@Component({
  ...
  template: `<ejs-schedule height="850" width="1250" [eventSettings]="eventSettings" [selectedDate]="selectedDate" (actionBegin)="getNewFromPlano()" (actionComplete)="printArgs($event)"> </ejs-schedule>`
})
...
getAllCRMActions(){
  const headers = {'content-type':'application/json','key':'1de6a576-7589-438d-8868-0956d012c415'}
  this.http.get<any>("http://65.108.6.222/api/crm/crmactions",{'headers':headers}).pipe(
    tap(resp => {
